...
<?php endif; ?>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_width]" class="regular-text" type="text" name="ct_theme_options[logo_width]" placeholder="<?php echo CHURCHTHEMES_OPTIONS_LOGO_WIDTH; ?>" value="<?php echo wp_filter_nohtml_kses( $options['logo_width'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_height]" class="regular-text" type="text" name="ct_theme_options[logo_height]" placeholder="<?php echo CHURCHTHEMES_OPTIONS_LOGO_HEIGHT; ?>" value="<?php echo wp_filter_nohtml_kses( $options['logo_height'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_top_margin]" class="regular-text" type="text" name="ct_theme_options[logo_top_margin]" placeholder="<?php echo CHURCHTHEMES_OPTIONS_LOGO_TOP_MARGIN ?>" value="<?php wp_filter_nohtml_kses( $options['logo_top_margin'] ); ?>" />
					</td>
					<td class="info">
...
<?php endif; ?>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[search_results_title]" class="regular-text" type="text" name="ct_theme_options[search_results_title]" placeholder="<?php _e( 'Search Results', 'churchthemes' ); ?>" value="<?php echo wp_filter_nohtml_kses( $options['search_results_title'] ); ?>" />
					</td>
					<td class="info">
