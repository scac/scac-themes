        ...
        <!-- Place holder img !-->
				...
				<div class="clearfix">
					...
					<div class="col-one-third">
						...
						<p>
							<b>Contact Us</b><br />
							Main building - Polly<br />
							(206) 725-0771 ext. 10<br />
							<a href="mailto:pollywong@scacseattle.org">Ms. Polly Wong</a>
						</p>
						<p>
							(206) 725-0771 ext. 11<br />
							<a href="mailto:bettywong@scacseattle.org">Ms. Betty Wong</a>
						</p>
					</div>
				</div>

				<div class="dir-entry-container">
					<!-- Directions form. -->
