...
?>
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_sl_tagline" size="70" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($sl_tagline); ?>">
	...
	<div class="meta_item">
		...
		<textarea type="text" name="_ct_sl_notes" cols="60" rows="8"><?php echo wp_filter_nohtml_kses($sl_notes); ?></textarea>
	</div>
...
function save_ct_sl_meta(){
	...
	if(isset($_POST['post_type']) && ($_POST['post_type'] == "ct_slide")):
		...
		$sl_linkurl = esc_url( $_POST['_ct_sl_linkurl'] );
...
// Start HTML
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_sm_audio_button_text" size="30" autocomplete="on" placeholder="<?php _e('e.g. Audio (MP3)', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($sm_audio_button_text); ?>" />
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_sm_video_button_text" size="30" autocomplete="on" placeholder="<?php _e('e.g. Video (MP4)', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($sm_video_button_text); ?>" />
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_sm_sg_button_text" size="30" autocomplete="on" placeholder="<?php _e('e.g. Study Guide', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($sm_sg_button_text); ?>" />
...
function save_ct_sm_meta(){
	...
	if(isset($_POST['post_type']) && ($_POST['post_type'] == "ct_sermon")):
		...
		$sm_audio_file = esc_url( $_POST['_ct_sm_audio_file'] );
...
?>
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_loc_address1" size="40" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_address1); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_address2"><?php _e('Address Line 2', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_address2" size="40" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_address2); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_address3"><?php _e('Address Line 3', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_address3" size="40" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_address3); ?>" />
	</div>
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_loc_service1" size="20" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_service1); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_service2"><?php _e('Service 2', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_service2" size="20" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_service2); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_service3"><?php _e('Service 3', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_service3" size="20" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_service3); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_service4"><?php _e('Service 4', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_service4" size="20" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_service4); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_loc_service5"><?php _e('Service 5', 'churchthemes'); ?></label>
		<input type="text" name="_ct_loc_service5" size="20" autocomplete="on" value="<?php echo wp_filter_nohtml_kses($loc_service5); ?>" />
	</div>
	...
	<div class="meta_item">
		...
		<textarea type="text" name="_ct_loc_notes" cols="60" rows="8"><?php echo wp_filter_nohtml_kses($loc_notes); ?></textarea>
	</div>
...
function save_ct_loc_meta(){
	...
	if(isset($_POST['post_type']) && ($_POST['post_type'] == "ct_location")):
		...
		$loc_map_link = wp_filter_nohtml_kses( $_POST['_ct_loc_map_link'] );
		update_post_meta($post_id, '_ct_loc_map_link', $loc_map_link);

		$loc_map_code = wp_filter_nohtml_kses( $_POST['_ct_loc_map_code'] );
...
?>
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_ppl_role" size="50" autocomplete="on" placeholder="<?php _e('e.g. Senior Pastor', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_role); ?>" />
	</div>
	...
	<div class="meta_item">
		...
		<input type="text" name="_ct_ppl_emaillabel" size="20" autocomplete="on" placeholder="<?php _e('e.g. Email Me', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_emaillabel); ?>" />
	</div>

	<div class="meta_item">
		<label for="_ct_ppl_emailaddress"><?php _e('Email Address', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_emailaddress" size="50" autocomplete="on" placeholder="<?php _e('e.g. first.last@mychurch.org', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_emailaddress); ?>" />
	</div>
	...
	<div class="meta_item phone_label">
		...
		<input type="text" name="_ct_ppl_phonelabel1" size="20" autocomplete="on" placeholder="<?php _e('e.g. Office', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_phonelabel1); ?>" />
	</div>

	<div class="meta_item phone_number">
		<label for="_ct_ppl_phonenum1"><?php _e('Phone Number 1', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_phonenum1" size="20" autocomplete="on" placeholder="+x (xxx) xxx-xxxx" value="<?php echo wp_filter_nohtml_kses($ppl_phonenum1); ?>" />
	</div>

	<div class="meta_item phone_label">
		<label for="_ct_ppl_phonelabel2"><?php _e('Phone Label 2', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_phonelabel2" size="20" autocomplete="on" placeholder="<?php _e('e.g. Mobile', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_phonelabel2); ?>" />
	</div>

	<div class="meta_item phone_number">
		<label for="_ct_ppl_phonenum2"><?php _e('Phone Number 2', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_phonenum2" size="20" autocomplete="on" placeholder="+x (xxx) xxx-xxxx" value="<?php echo wp_filter_nohtml_kses($ppl_phonenum2); ?>" />
	</div>

	<div class="meta_item phone_label">
		<label for="_ct_ppl_phonelabel3"><?php _e('Phone Label 3', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_phonelabel3" size="20" autocomplete="on" placeholder="<?php _e('e.g. Fax', 'churchthemes'); ?>" value="<?php echo wp_filter_nohtml_kses($ppl_phonelabel3); ?>" />
	</div>

	<div class="meta_item phone_number">
		<label for="_ct_ppl_phonenum3"><?php _e('Phone Number 3', 'churchthemes'); ?></label>
		<input type="text" name="_ct_ppl_phonenum3" size="20" autocomplete="on" placeholder="+x (xxx) xxx-xxxx" value="<?php echo wp_filter_nohtml_kses($ppl_phonenum3); ?>" />
	</div>
	...
	<div class="meta_item">
		...
		<textarea type="text" name="_ct_ppl_notes" cols="60" rows="8"><?php echo wp_filter_nohtml_kses($ppl_notes); ?></textarea>
	</div>
